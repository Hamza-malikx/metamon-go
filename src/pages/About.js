...
export default function About() {
  return (
    <>
      ...
      <Box bg="white" id="about" pb="60px" className="jumptarget">
        <Flex
        ...
        >
          ...
          >
            <Image
              ...
              // src={`${process.env.PUBLIC_URL}/r4.png`}
              // src={"img1"}
              w={{ base: '80px', md: '130px' }}
              style={{ borderBottomLeftRadius: '0px', padding: '20px' }}
            />
          ...
          >
            ...
            <List mt="14px" w={{ base: '100%', md: '430px' }}>
              <ListItem className="list_anam">
                ...
                >
                  <strong>
                    10,000 Trainers | Presale 14 April | Public Mint 15 April
                  </strong>
                </Text>
              </ListItem>
              <ListItem className="list_anam">
                ...
                >
                  <strong>
                    10,000 Metamons Mintable | Presale 16 April | Public Mint 17
                    April
                  </strong>
                </Text>
              </ListItem>
              <ListItem className="list_anam">
                ...
                >
                  <strong>
                    10,000 Lands Buildable | Presale 18 April | Public Mint 19
                    April
                  </strong>
                </Text>
              </ListItem>
              ...
              <ListItem className="list_anam">
                ...
                >
                  <strong>
                    40,000 Metaballs Mintable | Presale 20 April | Public Mint
                    21 April
                  </strong>
                </Text>
              </ListItem>
              <ListItem className="list_anam">
                ...
                >
                  <strong>
                    40,000 Metamons in game to Catch with your Metaball
                  </strong>
                </Text>
              </ListItem>
              <ListItem className="list_anam">
                ...
                <Text
                  ...
                  display="inline-block"
                >
                  <strong>Legendary: 300 Dragons that want to go Wild</strong>
                </Text>
              </ListItem>
              <ListItem className="list_anam">
                <ListIcon
                ...
                <Text
                  ...
                  display="inline-block"
                >
                  <strong>Token Type is ERC-721</strong>
                </Text>
              </ListItem>
            </List>
          </Box>
